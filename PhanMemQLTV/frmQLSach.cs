...
namespace PhanMemQLTV
{
    public partial class frmQLSach : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (txtNamXB.Text == ""|| isNumberNamXB == false)
            {
            ...
            if (txtSLNhap.Text == ""|| isNumberSLNhap == false)
            {
            ...
            if (txtDonGia.Text == "" || isNumberDonGia == false)
            {
            ...
            //    errSLNhap.SetError(txtSLNhap,"Nhập số lượng");
            //}
