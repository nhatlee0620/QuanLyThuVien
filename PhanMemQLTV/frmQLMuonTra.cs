...
namespace PhanMemQLTV
{
    public partial class frmQLMuonTra : Form
    {
        ...
        public DateTime NGAYMUON0, NGAYTRA0;
        private void dataGridViewDSMuon0_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                NGAYMUON0 = Convert.ToDateTime(myTable.Rows[row]["NgayMuon"].ToString(), System.Globalization.CultureInfo.GetCultureInfo("ur-PK").DateTimeFormat);
                dtmNgayMuon0.Text = NGAYMUON0.ToString();
                ngayMuon0 = dtmNgayMuon0.Text;
                NGAYTRA0 = Convert.ToDateTime(myTable.Rows[row]["NgayTra"].ToString(), System.Globalization.CultureInfo.GetCultureInfo("ur-PK").DateTimeFormat);
                dtmNgayTra0.Text = NGAYTRA0.ToString();
        ...
        public static DateTime newday = today.AddDays(90);
        ...
        private void cboMaSach0_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                while (myDataReaderSach.Read())
                {
                    ...
                    txtTTTenTG.Text = myDataReaderSach.GetString(3);
            ...
            {
                MessageBox.Show("Không có độc giả nào đang mượn sách", "Thông báo");
            }
        ...
        private void muonSach()
        {
            ...
            if(cboTinhTrang0.Text == "")
            {
                errTinhTrang0.SetError(cboTinhTrang0, "Vui lòng nhập tình trạng sách");
            }
            else
            {
                errTinhTrang0.Clear();
            ...
            if (txtSLMuon0.Text == ""|| isNumberSLNhap == false)
            {
                errSLMuon0.SetError(txtSLMuon0, "Vui lòng nhập SL Mượn đúng định dạng chữ số");
            }
            else
            {
                errSLMuon0.Clear();
            ...
            soSanhNgay();
            if (txtSLMuon0.Text.Length > 0 && cboMaDG0.Text.Length > 0 && cboMaSach0.Text.Length > 0 && cboTinhTrang0.Text.Length > 0 && isNumberSLNhap == true)
            {
                        ...
                        if (kq == 1)
                        {
                            ...
                            if (ktmuonchua == 0)
                            {
                                try
                                {
                                    ...
                                    myCommand.ExecuteNonQuery();
                                    myConnection.Close();
                                    MessageBox.Show("Đã cập nhật SL Sách vào thư viện.", "Thông Báo");
                ...
                {
                    MessageBox.Show("Số lượng sách còn trong thư viện không đáp ứng được.", "Thông Báo");
                    txtSLMuon0.Text = "";
                    txtSLMuon0.Focus();
                }
            }
        ...
        private void giaHanSach()
        {
            ...
            if (kq == 1)
            {
                string strCapNhatSLCon = "update tblHSPhieuMuon set NgayMuon = '"+ dtmNgayMuon0.Text +"', NgayTra = '"+ dtmNgayTra0.Text +"', TinhTrang = N'"+ cboTinhTrang0.Text +"', GhiChu = N'"+txtGhiChu0.Text +"' where MaPhieu='" + txtMaPhieu0.Text + "'";
                ketnoi(strCapNhatSLCon);
                myCommand.ExecuteNonQuery();
        ...
        private void btnHuy0_Click(object sender, EventArgs e)
        {
            ...
            cboMaSach0.Text = maSach0;
            txtSLMuon0.Text = slMuon0;
            NGAYMUON0 = Convert.ToDateTime(dtmNgayMuon0.Text, System.Globalization.CultureInfo.GetCultureInfo("ur-PK").DateTimeFormat);
            dtmNgayMuon0.Text = NGAYMUON0.ToString();
            NGAYTRA0 = Convert.ToDateTime(dtmNgayTra0.Text, System.Globalization.CultureInfo.GetCultureInfo("ur-PK").DateTimeFormat);
            dtmNgayTra0.Text = NGAYTRA0.ToString();
            txtGhiChu0.Text = ghiChu0;
        ...
        public DateTime NGAYMUON1, NGAYTRA1;
        private void dataGridViewDSMuon1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                NGAYMUON1 = Convert.ToDateTime(myTable.Rows[row]["NgayMuon"].ToString(), System.Globalization.CultureInfo.GetCultureInfo("ur-PK").DateTimeFormat);
                dtmNgayMuon1.Text = NGAYMUON1.ToString();
                ngayMuon1 = dtmNgayMuon1.Text;

                NGAYTRA1 = Convert.ToDateTime(myTable.Rows[row]["NgayTra"].ToString(), System.Globalization.CultureInfo.GetCultureInfo("ur-PK").DateTimeFormat);
                dtmNgayTra1.Text = NGAYTRA1.ToString();
