    ...
    public partial class frmQLDocGia : Form
    {
        ...
        private void dataGridViewDSDocGia_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                NS = Convert.ToDateTime(myTable.Rows[row]["NgaySinhDG"].ToString(), System.Globalization.CultureInfo.GetCultureInfo("ur-PK").DateTimeFormat);
                dtmNgaySinh.Text = NS.ToString();
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if(isNumberSDT==false || txtSoDT.Text.Length>12)
            {
                ...
                errSDT.SetError(txtSoDT, "Nhập SDT không đúng.");
            }
            else
            {
                errSDT.Clear();
        ...
        private void btnHuy_Click(object sender, EventArgs e)
        {
            ...
            NS = Convert.ToDateTime(dtmNgaySinh.Text, System.Globalization.CultureInfo.GetCultureInfo("ur-PK").DateTimeFormat);
            dtmNgaySinh.Text = NS.ToString();
